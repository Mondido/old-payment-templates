/*  Mondido mondido.payment.js v2.1.0, (c) Mondido Payments AB 2016, hello@mondido.com */
...
(function($) {
  ...
  if (mondidoSettings.layout.accept_terms_requirement == true){
    $(".accept-payment-terms-div").show();
    $("form").each(function() {
      $(this).addClass("accept-terms");
    });
...
jQuery(function($) {
  ...
  $('#invoiceform').submit(function(e) {
    if ($(this).hasClass("accept-terms") == true){
      if($('#accept-payment-terms-invoice').is(':checked') == false){
  ...
  $('#trustlyform-terms').submit(function(e) {
    if ($(this).hasClass("accept-terms") == true){
      if($('#accept-payment-terms-trustly').is(':checked') == false){
        alert("You need to accept the terms");
        return false;
      }
    }

    $("#trustlyform-terms").hide();
    $(".trustly-frame").show();
    $('#trustlyform').submit();
  ...
  $('#swishform').submit(function(e) {
    if ($(this).hasClass("accept-terms") == true){
      if($('#accept-payment-terms-swish').is(':checked') == false){
        alert("You need to accept the terms");
        return false;
      }
    }
  ...
  $('#paypalform').submit(function(e) {
    if ($(this).hasClass("accept-terms") == true){
      if($('#accept-payment-terms-paypal').is(':checked') == false){
        alert("You need to accept the terms");
        return false;
      }
    }
  ...
  $('#mondidopayform').on('submit', function(e) {
    var checks = true;
    ...
    if ($(this).hasClass("accept-terms") == true){
      if($('#accept-payment-terms-credit-card').is(':checked') == false){
        console.log("accept-payment-terms-credit-card");
        errString += " Accepterar villkoren";
        checks = false;
      }
    }
...
$(document).ready(function() {
  ...
  $("#checkoutButtonDiv").click(function(e) {
    if ($("#masterpassform").hasClass("accept-terms") == true){
      if($('#accept-payment-terms-masterpass').is(':checked') == false){
        alert("You need to accept the terms");
        return false;
      }
    }
